...
const CurrentComponent = navigation.find(item => item.name === currentPage)?.component || Dashboard;
              ...
              <nav className="flex flex-1 flex-col">
                <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li key={item.name}>
                          <a
                            ...
                            className={classNames(
                              currentPage === item.name
                                ...
                                : 'text-blue-200 hover:bg-blue-950 hover:text-white',
                          ...
                          >
                            <item.icon
                              aria-hidden="true"
                              className={classNames(
                                currentPage === item.name ? 'text-white' : 'text-blue-200 group-hover:text-white',
                                'h-6 w-6 shrink-0',
                              )}
                            />
                            {item.name}
                  ...
                  <li className="mt-auto">
                    <a
                      href="#"
                      className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-blue-200 hover:bg-blue-950 hover:text-white"
                    >
                      <Cog6ToothIcon
                        aria-hidden="true"
